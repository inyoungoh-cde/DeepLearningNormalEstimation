...
parser.add_argument('--normal_results_path', type=str, default='./log_ablation_noLw/test_GAB_RPE/results/', help='Log dir [default: log]') #./log_ablation_noLw/test_LAB12345+GAB_order4/results/
...
for dataset in dataset_list:
    PC_PATH='/home/aidean/Downloads/mcpa_raw/data/pcpnet/'
